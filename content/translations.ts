export const translations = {
  en: {
    ...
    protected: {
      ...
      premiumOnly: 'This page is only accessible to premium users',
      goHome: 'Go Home',
      goLogin: 'Go to Login',
    },
    hero: {
  ...
  he: {
    ...
    protected: {
      ...
      loginRequired: 'אנא התחבר כדי לגשת לדף זה',
      adminOnly: 'דף זה נגיש למנהלי מערכת בלבד',
      premiumOnly: 'דף זה נגיש למשתמשי פרימיום בלבד',
      goHome: 'חזור לדף הבית',
      goLogin: 'עבור להתחברות',
    },
    hero: {
